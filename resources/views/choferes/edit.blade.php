...
<form action="{{ route('choferes.update', $chofer) }}" method="POST">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" name="nombre" class="form-control" value="{{ old('nombre', $chofer->nombre) }}">
        </div>
        <div class="col-md-6">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" name="licencia" class="form-control" value="{{ old('licencia', $chofer->licencia) }}">
        </div>
        <div class="col-md-6">
            <label class="form-label fw-bold">Teléfono</label>
            <input type="text" name="telefono" class="form-control" value="{{ old('telefono', $chofer->telefono) }}">
        </div>
    </div>
